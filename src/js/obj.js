...
at < anonymous >: 1: 12(anonymous) @ VM2012: 1
list.shift(obj2) {
    elementId: "modal",
    size: {
        …},
...
list.unshift(obj2)
3
var listOfIds = list.flatMap(dict => {
    return dict.elementId === "cats" ? dict.elementId : false
})
undefined
